...
interface LeftSidebarProps {
  ...
  activeTab: 'chapters' | 'outline' | 'scene' | 'versions' | 'evaluation';
  onTabChange: (tab: 'chapters' | 'outline' | 'scene' | 'versions' | 'evaluation') => void;
          ...
          <section className="px-3 pb-4 border-b border-gray-100">
            ...
            <ul className="space-y-1">
              ...
              <li>
                ...
                >
                  <svg
                    className={`w-4 h-4 ${activeTab === 'scene' ? 'text-gray-900' : 'text-gray-400 group-hover:text-gray-600'}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
