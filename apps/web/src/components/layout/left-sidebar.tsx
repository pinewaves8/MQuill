...
export function LeftSidebar({
  ...
  return (
    <aside className="w-sidebar bg-white border-r border-gray-200 flex flex-col h-full z-20 shadow-sm">
      {/* Header */}
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (res.ok) {
                    ...
                    // Refresh the chapters list from server and update parent state
